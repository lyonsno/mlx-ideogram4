...
class AppHardeningTests(unittest.TestCase):
    def test_normalize_request_caps_prompt_bad_preset_and_public_limits(self):
        ...
        self.assertEqual(512, fallback_request.width)
        self.assertEqual(512, fallback_request.height)
        ...
        self.assertEqual(512, twenty_step_request.width)
        self.assertEqual(512, twenty_step_request.height)
    ...
    def test_public_ui_limits_prompt_preset_and_resolution(self):
        ...
        self.assertEqual(512, sliders[0].args[1])
        self.assertEqual(512, sliders[1].args[1])
    ...
    def test_public_copy_matches_public_caps_and_tone(self):
        ...
        self.assertNotIn("1024 px max", site)
