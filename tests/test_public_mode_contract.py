...
class PublicModeContractTest(unittest.TestCase):
    def test_public_mode_forces_launch_shape(self):
        ...
        try:
            long_prompt = "x" * (ns["MAX_PROMPT_CHARS"] + 25)
        ...
        self.assertEqual(prompt, long_prompt[:ns["MAX_PROMPT_CHARS"]])
    ...
    def test_public_mode_contract_constants_name_the_demo(self):
        ...
        self.assertEqual(ns["MAX_PROMPT_CHARS"], 2000)
    ...
    def test_tokenizer_and_hf_token_paths_are_nonfragile(self):
        source = APP_PATH.read_text()
