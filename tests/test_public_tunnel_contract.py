...
class PublicTunnelContractTest(unittest.TestCase):
    ...
    def test_reddit_landing_page_contract(self):
        ...
        self.assertNotIn("one public queue slot", source)
        self.assertNotIn("12 or 20 sampling steps", source)
        self.assertNotIn("Dependency help", source)
        self.assertNotIn("bad time", source)
